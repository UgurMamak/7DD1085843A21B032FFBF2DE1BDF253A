...
jQuery(document).ready(function ($) {
  ...
  function renderPrimaryRadioBtn() {
    $('[data-wrap="radioList"]').each(function (index, listItem) {
  ...
  function renderPrimarySelect2(vue) {
    $('.primary-select2').each(function (index, item) {
      $(item).select2({
        width: '100%',
  ...
  function formValidation(form) {
    form.validate({
      ...
      highlight: function highlight(element) {
        console.log(element);
        var $this = $(element); //$this.parents($this[0].type === "checkbox" || $this[0].type === "radio" ? '[data-wrap="radioList"]' : '.input-group').addClass('has-error');
      ...
      errorPlacement: function errorPlacement(error, element) {
        ...
        if ($this[0].type == "checkbox" || $this[0].type == "radio") {} else {
          $this.parents('.input-group').append(error);
        }
      }
    });
    form.find('.primary-select2').on('change', function (e) {
      $(e.target).valid();
    });
  }
  ...
  (function () {
    function formElement() {
      var form = {};
      $('#stepWrap').find('[name]').map(function (index, item) {
        form[$(item).attr('name')] = "";
      });
      return form;
    }
    ...
    new Vue({
      ...
      methods: {
        actionStep: function actionStep(step) {
          var _this = this;
          ...
          setTimeout(function () {
            _this.activeStep = _this.activeStep + step;
          });
        },
        submitAction: function submitAction() {
          ...
          if (!$(this.$el).find('[data-toggle="form"]').valid()) return;
          axios.post($(this.$el).find('[data-toggle="form"]').attr('data-url'), {}).then(function (response) {
        ...
        cancelReservationShow: function cancelReservationShow() {
